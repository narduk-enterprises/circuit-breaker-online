...
<template>
  <div class="min-h-screen flex items-center justify-center bg-muted/50 dark:bg-muted px-4">
    <div class="text-center max-w-md">
      ...
      <!-- Title -->
      <h1 class="text-2xl font-semibold text-default dark:text-default mb-3">
        {{ title }}
      </h1>

      <!-- Description -->
      <p class="text-muted dark:text-dimmed mb-8">
        {{ description }}
      </p>
