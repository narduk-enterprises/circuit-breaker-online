...
const brandsData: Record<
  string,
  { name: string; description: string; content: string; models: string[]; services: string[] }
> = {
  'general-electric': {
    name: 'General Electric (GE)',
    description:
      'One of the largest inventories of GE circuit breakers and switchgear in North America. New, reconditioned, and remanufactured GE equipment — from legacy AK/AKR to modern EntelliGuard.',
    content:
    ...
    services: [
      'GE breaker reconditioning',
      'AKR trip unit upgrades',
      'EntellliGuard retrofill',
      'GE switchgear retrofill',
  ...
  westinghouse: {
    ...
    models: [
      ...
      'DHP-VR 4.16-15kV',
      'SPB-100',
      '150VCP-W 500/750/1000',
    ],
    services: [
      'DS/DSL overhaul',
      'Amptector trip unit repair',
      'DHP vacuum breaker service',
      'Magnum retrofill programs',
      'Legacy parts sourcing',
  ...
  siemens: {
    name: 'Siemens',
    description:
      'New and reconditioned Siemens circuit breakers and switchgear components. From RL/RLX air breakers to modern WL and GMSG vacuum equipment.',
    content:
      '<p>Siemens power circuit breakers and switchgear are found throughout industrial, commercial, and utility substations worldwide. Circuit Breaker Sales provides new and reconditioned Siemens breakers across the full product line.</p><p>We specialize in hard-to-find legacy Siemens (and I-T-E) equipment, including the popular RL/RLX series, as well as modern WL breakers and GMSG medium voltage switchgear components.</p>',
    models: [
      'RL-800/1600/2000/3200',
      'RLX-800',
      'WL Breakers',
      'SB Series',
      'GMSG Switchgear',
      'MA/MC Medium Voltage',
      'SDV6 Vacuum',
      '81000/3WX Breakers',
    ],
    services: [
      'RL/RLX reconditioning',
      'WL breaker service',
      'Trip unit upgrades',
      'GMSG switchgear retrofit',
      'Medium voltage overhaul',
      'Legacy ITE sourcing',
    ],
  },
  'cutler-hammer': {
    ...
    description:
      'Full inventory of Cutler-Hammer circuit breakers, motor controls, and switchgear. Legacy and current production Eaton/Cutler-Hammer equipment.',
    content:
      '<p>Cutler-Hammer (now Eaton) circuit breakers and switchgear are among the most commonly installed electrical equipment in commercial and industrial facilities. Circuit Breaker Sales maintains a comprehensive inventory of Cutler-Hammer power circuit breakers, motor controls, and replacement parts.</p><p>From legacy Type SPB and HMCP breakers to modern Magnum and Digitrip trip units, we can supply and service the full Cutler-Hammer product line.</p>',
    models: [
      'SPB-100',
      'HMCP Series',
      'HFD/HKD/HLD',
      'Magnum DS',
      'Type W-2/W-3 Starters',
      'AN/AE Starters',
      'Freedom Series',
      'Advantage Starters',
    ],
  ...
  'square-d': {
    ...
    description:
      'New and reconditioned Square D and Schneider Electric circuit breakers. Masterpact, DS/DSL, I-Line, and QO/QOB product lines.',
    content:
      '<p>Square D (now Schneider Electric) circuit breakers and panelboards are found in facilities of all sizes. Circuit Breaker Sales provides new and reconditioned Square D power circuit breakers, including the Masterpact series, legacy DS/DSL types, and I-Line distribution equipment.</p><p>We also carry a wide selection of Square D molded case circuit breakers for panel and switchboard applications, along with replacement trip units and accessories.</p>',
    models: [
      'Masterpact NW/NT',
      'DS-206/416/632',
      'QO/QOB Series',
  ...
  abb: {
    name: 'ABB',
    description:
      'ABB circuit breakers, switchgear, and medium voltage equipment. SACE Emax, VD4, and legacy BBC product lines.',
    content:
      '<p>ABB is a global leader in electrical equipment manufacturing with a strong presence in both low and medium voltage markets. Circuit Breaker Sales provides new and reconditioned ABB circuit breakers and switchgear components, including the popular SACE Emax low voltage breaker line and VD4 medium voltage vacuum breakers.</p><p>We also carry legacy BBC (Brown Boveri) equipment for older installations, as well as ABB protective relays and motor control products.</p>',
    models: [
      'SACE Emax E1-E6',
      'SACE Emax 2',
      'VD4 Vacuum Breakers',
    ...
    services: [
      'Emax reconditioning',
      'VD4 vacuum interrupter replacement',
      'ABB relay testing',
      'HD4 overhaul',
      'Legacy BBC sourcing',
      'ABB switchgear retrofit',
    ],
  },
}
  ...
  <div>
    <section class="gradient-industrial hero-grid relative overflow-hidden">
      ...
      <div class="relative mx-auto max-w-7xl px-4 pb-16 pt-20 sm:pb-20 sm:pt-28">
        ...
        <p class="mb-8 max-w-2xl text-lg leading-relaxed text-white/70">
          {{ currentBrand?.description }}
        </p>
        <div class="flex flex-wrap gap-4">
          <UButton
            :to="`/products?brand=${encodeURIComponent(currentBrand?.name || '')}`"
            size="lg"
            color="primary"
            >Browse {{ currentBrand?.name }} Inventory</UButton
          >
      ...
      <div class="grid gap-12 lg:grid-cols-3">
        <div class="lg:col-span-2 space-y-8">
          <div class="light-card rounded-xl p-8">
            <h2 class="mb-4 font-display text-xl font-semibold text-default">
              {{ currentBrand?.name }} Equipment We Carry
            </h2>
            <!-- eslint-disable-next-line vue/no-v-html -->
            <div
              class="space-y-4 text-sm leading-relaxed text-muted"
              v-html="currentBrand?.content"
            />
          </div>
          ...
          <div>
            ...
            <div class="grid gap-3 sm:grid-cols-2">
              <div
                ...
                :key="model"
                class="light-card rounded-lg px-4 py-3"
              >
        ...
        <div class="space-y-6">
          <div class="light-card border-default rounded-xl p-6">
            ...
            >
              Services for {{ currentBrand?.name }}
            </h3>
          ...
          <div class="light-card rounded-xl p-6">
            ...
            <p class="mb-4 text-sm text-dimmed">
              Can't find what you need? We can source virtually any {{ currentBrand?.name }} part or
              breaker.
            </p>
