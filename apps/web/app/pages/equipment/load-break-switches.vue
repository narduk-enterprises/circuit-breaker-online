...
useSeo({
  title: 'Medium Voltage Load Break Switches | Circuit Breaker Sales',
  ...
  keywords: ['load break switch', 'load interrupter switch', 'medium voltage switch', 'disconnect switch', 'pad-mount switch'],
  ogImage: { title: 'Load Break Switches', description: 'Medium Voltage Switching Solutions', icon: '⚡' },
})
useBreadcrumbSchema([
  { name: 'Home', url: 'https://circuitbreaker.online/' },
  { name: 'Equipment', url: 'https://circuitbreaker.online/equipment' },
  { name: 'Load Break Switches', url: 'https://circuitbreaker.online/equipment/load-break-switches' },
])
useFAQSchema([
  { question: 'What is the difference between a load break switch and a disconnect switch?', answer: 'A load break switch can safely open and close circuits while carrying load current. A disconnect switch (isolating switch) is designed only for visible isolation when the circuit is already de-energized. Using a disconnect switch under load can cause dangerous arcing.' },
  { question: 'What types of load break switches does Circuit Breaker Sales carry?', answer: 'We carry bolted pressure switches, vacuum load interrupter switches, SF6 switches, and pad-mount switches for underground distribution. Brands include GE, S&C Electric, Westinghouse, Siemens, ABB, and Eaton.' },
])
