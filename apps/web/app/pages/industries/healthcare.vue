...
const pageData = {
  ...
  description: 'Life-safety electrical equipment for hospitals, ambulatory surgery centers, and medical campuses. When lives depend on reliable power, Circuit Breaker Sales delivers.',
  accentColor: 'rose',
  solutions: [
